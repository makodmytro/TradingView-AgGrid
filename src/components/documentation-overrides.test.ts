...
const OVERRIDES_TO_TEST = [
    ...
    'integrated-charts-api-cross-filter-chart-original/resources/cross-filter-api.json',
    'integrated-charts-api-pivot-chart-original/resources/chart-original-api.json',
    'integrated-charts-api-range-chart-original/resources/chart-original-api.json',
