...
const VanillaCode = ({ options }) => (
    <>
        <Code code={['// Create new chart-original', `chart = AgChart.create(${formatJson(options)});`]} />
        <Code code={['// Update existing chart-original', `AgChart.update(chart, ${formatJson(options)});`]} />
    </>
);
