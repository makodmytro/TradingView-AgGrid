 ...
 */
const TYPE_LINKS = {
    AgChartTheme: '/integrated-charts-customisation/#custom-chart-original-themes',
    ...
    AgBarSeriesOptions: '/integrated-charts-customisation/#example-barcolumn-chart-original-overrides',
    AgLineSeriesOptions: '/integrated-charts-customisation/#example-line-chart-original-overrides',
    AgAreaSeriesOptions: '/integrated-charts-customisation/#example-area-chart-original-overrides',
    AgScatterSeriesOptions: '/integrated-charts-customisation/#example-scatter-chart-original-overrides',
    AgHistogramSeriesOptions: '/integrated-charts-customisation/#example-histogram-chart-original-overrides',
    AgPolarChartOptions: '/integrated-charts-customisation/#example-piedoughnut-chart-original-overrides',
    AgPolarAxesTheme: '/integrated-charts-customisation/#example-piedoughnut-chart-original-overrides',
    AgPolarSeriesTheme: '/integrated-charts-customisation/#example-piedoughnut-chart-original-overrides',
    AgPieSeriesOptions: '/integrated-charts-customisation/#example-piedoughnut-chart-original-overrides',
    ...
    CreatePivotChartParams: '/integrated-charts-api-pivot-chart-original/#pivot-chart-original-api',
    CreateRangeChartParams: '/integrated-charts-api-range-chart-original/#range-chart-original-api',
